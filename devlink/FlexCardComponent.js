...
import _styles from "./FlexCardComponent.module.css";

export function FlexCardComponent({
  as: _Component = _Builtin.Section,
  image = "https://cdn.prod.website-files.com/68f62d1c547c12e49e27549e/6902615189818e278c7fc2eb_lifetime-warranty.png",
  heading = "Limited Lifetime Warranty",
  subHeading = "Every repair includes a limited lifetime warranty — because we stand by our work.",
  paragraph = "After over a decade in the repair business, we’ve come to understand some of the most common issues affecting electronics such as phones, computers and consoles. The articles below provide insight on some...",
}) {
  return (
    <_Component
      className={_utils.cx(_styles, "cell_phone_warranty")}
      grid={{
        type: "section",
      }}
      tag="section"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "warranty_image_container")}
        tag="div"
      >
        <_Builtin.Image
          ...
          height="auto"
          alt=""
          src="https://cdn.prod.website-files.com/68f62d1c547c12e49e27549e/6902615189818e278c7fc2eb_lifetime-warranty.png"
        />
      </_Builtin.Block>
      <_Builtin.Block
        className={_utils.cx(_styles, "warranty_content_holder")}
        tag="div"
      >
        <_Builtin.Heading
          className={_utils.cx(_styles, "warranty-heading")}
          tag="h4"
        >
          {heading}
        </_Builtin.Heading>
        <_Builtin.Heading
          className={_utils.cx(
            _styles,
            "warrant_heading",
            "warrant-sub-heading-margin"
          )}
          tag="h5"
        >
          {subHeading}
        </_Builtin.Heading>
        <_Builtin.Paragraph className={_utils.cx(_styles, "warranty-text")}>
          {paragraph}
        </_Builtin.Paragraph>
        <_Builtin.Block
          className={_utils.cx(_styles, "location", "u-mt-20")}
          tag="div"
        >
          <_Builtin.HtmlEmbed
